...
public class DeliveryBoyListener {
    ...
    public void recievedAndSaved(DeliveryBoyMQ deliveryBoyMQ) {
        ...
        System.out.println(deliveryBoyRepository.saveDeliveryBoy(deliveryBoyMQ.getUsername(),deliveryBoyMQ.getDeliveryBoyName(),"available", deliveryBoyLat+ "," + deliveryBoyLon));
